...
const playlist: Song[] = [
  { id: 1, title: "Tenu Sang Rakhna", file: Music1, cover: Cover1 },
  { id: 2, title: "Bhai Ni Beni Ladki", file: Music2, cover: Cover2 },
  { id: 3, title: "Phoolo Ka Taaron Ka", file: Music3, cover: Cover3 },
];
